 ...
 * Time: 11:19 AM
 */
// uelarn 11.10.15: Modified to support amd with jspm package manager, + params in queryAll optional

declare module 'localStorageDB' {

    export type localStorageDB_callback = (object: localStorageDB_fields) => localStorageDB_dynamicFields;
    export type localStorageDB_callbackFilter = (object: localStorageDB_fields) => boolean;
    ...
    export interface localStorageDB_fields extends localStorageDB_dynamicFields {
	ID: number;
}

    export interface localStorageDB_dynamicFields {
	[T: string]: any;
    }

    export interface localStorageDB_queryParams {
